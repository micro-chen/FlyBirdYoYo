...
namespace Taobao.Pac.Sdk.Core
{
    ...
    public sealed class RequestValidator
    {
        ...
        public static void ValidateRequired(string name, object value)
        {
            if (value == null)
            {
                throw new PacException(ERR_CODE_PARAM_MISSING, string.Format(ERR_MSG_PARAM_MISSING, name));
            }
            else
            {
        ...
        public static void ValidateMaxLength(string name, string value, int maxLength)
        {
            ...
            {
                throw new PacException(ERR_CODE_PARAM_INVALID, string.Format(ERR_MSG_PARAM_INVALID, name));
            }
        }
        ...
        public static void ValidateMaxListSize(string name, List<string> value, int maxSize)
        {
            if (value != null)
            {
                ...
                {
                    throw new PacException(ERR_CODE_PARAM_INVALID, ERR_MSG_PARAM_INVALID);
                }
            }
        }
        ...
        public static void ValidateObjectMaxListSize(string name, string value, int maxSize)
        {
            if (value != null)
            {
                IList list = Newtonsoft.Json.JsonConvert.DeserializeObject<List<object>>(value) as IList;
