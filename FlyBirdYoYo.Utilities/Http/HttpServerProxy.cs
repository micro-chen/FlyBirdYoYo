...
namespace FlyBirdYoYo.Utilities.Http
{
    ...
    public class HttpServerProxy : IDisposable
    {
        ...
        /// <param name="fromHeaders"></param>
        /// <returns></returns>
        public string Get(string url, NameValueCollection fromHeaders)
        {
            ...
            try
            {
                ...
                var tskResponse = this.GetAsync(url, fromHeaders);
                if (null == tskResponse)
                {
                    return string.Empty;
                }
        ...
        /// <param name="fromHeaders"></param>
        /// <returns></returns>
        public Task<HttpResponseMessage> GetAsync(string url, NameValueCollection fromHeaders = null)
        {
